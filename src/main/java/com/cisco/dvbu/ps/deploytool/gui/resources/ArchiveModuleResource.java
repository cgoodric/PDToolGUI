 ...
 */
@Path("/archive_module")
public class ArchiveModuleResource {

//    private static final Logger log = LoggerFactory.getLogger (ArchiveModuleResource.class);
    ArchiveModulesDAO dao = new ArchiveModulesDAO();
