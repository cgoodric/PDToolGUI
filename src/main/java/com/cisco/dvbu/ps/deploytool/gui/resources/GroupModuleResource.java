...
import com.cisco.dvbu.ps.deploytool.gui.core.module.group.GroupModulesDAO;
 ...
 */
@Path("/group_module")
public class GroupModuleResource {

    private static final Logger log = LoggerFactory.getLogger (GroupModuleResource.class);
    GroupModulesDAO dao = new GroupModulesDAO();
    ...
    /**
     * <p>
     * Uses the auto-generate facility to generate groups from a server based on a domain.
     * </p>
     * 
     * @param id        Path to the group module file.
     * @param serverId  The server from which to generate the groups.
     * @param domain    The domain in which to search for groups.
     * @param req       Servlet request object containing client request parameters.
