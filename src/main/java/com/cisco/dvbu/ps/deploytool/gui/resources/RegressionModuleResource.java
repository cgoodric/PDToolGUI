...
import com.cisco.dvbu.ps.deploytool.gui.core.module.regression.RegressionModulesDAO;
 ...
 * @version 1.0
 */
@Path("/regression_module")
public class RegressionModuleResource {

    private static final Logger log = LoggerFactory.getLogger (RegressionModuleResource.class);
    RegressionModulesDAO dao = new RegressionModulesDAO();
     ...
     * </p>
     */
    public RegressionModuleResource () {
        super ();
    }
     ...
     * </p>
     * 
     * @param id           Path to the regression module file.
