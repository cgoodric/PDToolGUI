    ...
    static {
        try {
            knownPropertiesREPattern = Pattern.compile(
                "^(?:SUPPRESS_COMMENTS|DEBUG1|DEBUG2|DEBUG3|DIFFMERGER_VERBOSE|allResourcesIndicator|exculdeResourcesIndiator|" +
                "excludeResourcesIndicator|userOptionThreshold|DataSourceModule_NonUpdateableAttributes|" +
                ...
                "VCS_MULTI_USER_TOPOLOGY|VCS_TYPE|VCS_HOME|VCS_COMMAND|VCS_EXEC_FULL_PATH|VCS_OPTIONS|VCS_WORKSPACE_INIT_NEW_OPTIONS|" +
                "VCS_WORKSPACE_INIT_LINK_OPTIONS|VCS_WORKSPACE_INIT_GET_OPTIONS|VCS_CHECKIN_OPTIONS|VCS_CHECKIN_OPTIONS_REQUIRED|" + 
                "VCS_CHECKOUT_OPTIONS|VCS_CHECKOUT_OPTIONS_REQUIRED|VCS_REPOSITORY_URL|" +
                "VCS_PROJECT_ROOT|VCS_WORKSPACE_HOME|VCS_WORKSPACE_NAME|VCS_WORKSPACE_DIR|VCS_TEMP_DIR|VCS_USERNAME|" +
