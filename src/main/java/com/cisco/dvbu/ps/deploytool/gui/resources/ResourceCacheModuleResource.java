...
import com.cisco.dvbu.ps.deploytool.gui.core.module.resource_cache.ResourceCacheModulesDAO;
...
/**
 * <p>
 * Servlet for working on resource cache modules.
 * </p>
 * 
 * @author Calvin Goodrich
 * @version 1.0
 */
@Path("/resource_cache_module")
public class ResourceCacheModuleResource {

//    private static final Logger log = LoggerFactory.getLogger (ResourceCacheModuleResource.class);
    ResourceCacheModulesDAO dao = new ResourceCacheModulesDAO();
     ...
     * </p>
     */
    public ResourceCacheModuleResource () {
        super ();
    }
    ...
    /**
     * <p>
     * Uses the auto-generate facility to generate resource caches from a server based on a start path and options.
     * </p>
     * 
     * @param id         Path to the resource cache module file.
     * @param serverId   The server from which to generate the resource caches.
     * @param startPath  The starting path in which to search for resources.
    ...
    public ResultMessage generate(
        ...
        return dao.generate (id, profilePath, serverId, startPath, options);
    }
}
